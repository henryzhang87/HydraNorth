module Hydranorth
  class AdditionalIdPresenter
    ...
    self.terms = [:resource_type, :title, :creator, :contributor, :trid, :ser, :description, :tag, :temporal, :spatial, :date_created, :rights, :subject, :related_url]
